...
url.get('https://www.jequiti.com.br/busca?ft=body%20splash#1')
#  #  #  #
...
# TAG MAE #
body_splash = soup.findAll('article', attrs={'class':'x-shelf__item has--category js--shelf-item'})
...
dados.to_csv('jequiti/body_splash/bodysplash.csv', index=False)
#  #  #  #