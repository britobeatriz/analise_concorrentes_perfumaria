...
url.get('https://www.avon.com.br/s/sabonete?map=term')
#  #  #  #
...
# TAG MAE #
sabonete = soup.findAll('div', attrs={'class':'css-1y7l0uq'})
...
dados.to_csv('avon/sabonete/sabonete.csv', index=False)
#  #  #  #