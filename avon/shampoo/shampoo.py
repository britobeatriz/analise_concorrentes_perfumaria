...
url.get('https://www.avon.com.br/s/shampoo?map=term')
#  #  #  #
...
# TAG MAE #
shampoo = soup.findAll('div', attrs={'class':'css-1y7l0uq'})
#print(antitranspirante.prettify())
#  #  #  #

# RASPANDO TODOS OS PRODUTOS #
for produto in shampoo:
...
dados.to_csv('avon/shampoo/shampoo.csv', index=False)
#  #  #  #